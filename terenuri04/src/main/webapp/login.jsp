	...
	<body>
		<center>
			...
			<s:form action="login" method="post">
				<table name="grid1" style="width: 50%">
					<tr>
						<td><s:textfield name="user.username"
								label="Ulilizator (adresa email-ANCPI)" /></td>
						
					</tr>
					<tr>
						<td><s:password name="user.password"
								label="Parola (parola de Windows-ANCPI)" /></td>
					</tr>
					<tr>
						<td><s:submit label="Login" /></td>
						<td><s:reset label="Reset" /></td>
					</tr>
				</table>
