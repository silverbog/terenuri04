...
<!--h2>A fost introdus teren cu ID=<c:out value="${teren.getId()} "></c:out></h2-->
<h2>A fost introdus teren, avand detaliile:</h2>
<h3><c:out value="${teren.toString()}" escapeXml="false"></c:out></h3>
